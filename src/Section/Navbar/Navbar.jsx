...
import pdf from "../../assets/confidence.pdf"

const Navbar = () => {

    const menu = <>
        <li><Link activeClass="active" to="home" spy={true} smooth={true} duration={250} className="cursor-pointer px-3">Home</Link></li>
        <li><Link activeClass="active" to="about" spy={true} smooth={true} duration={250} className="cursor-pointer px-3">About</Link></li>
        <li><Link activeClass="active" to="skills" spy={true} smooth={true} duration={250} className="cursor-pointer px-3">Skills</Link></li>
        <li><Link activeClass="active" to="projects" spy={true} smooth={true} duration={250} className="cursor-pointer px-3">Projects</Link></li>
        <li><Link activeClass="active" to="contuct" spy={true} smooth={true} duration={250} className="cursor-pointer px-3">Contuct</Link></li>
        <li>
